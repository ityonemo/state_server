defmodule StateServerTest.Callbacks.DelayedTransitionTest do
  ...
  test "delayed transition functions are respected" do
    test_pid = self()
    ...
    {:ok, srv} = Instrumented.start_link(fn ->
      {:reply, "foo", internal: {:wait, test_pid}, transition: :tr}
    end)
